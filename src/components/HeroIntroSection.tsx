...
export default function HeroIntroSection() {
  ...
  return (
    <section id="home" className="scroll-mt-12 space-y-8">
      {/* Section Header Tag */}
      ...
      {/* Stats Counter Bar */}
      <div className="pt-6">
        <div className="p-6 rounded-3xl bg-white dark:bg-gradient-to-r dark:from-[#1a1a1a] dark:via-[#161616] dark:to-[#1a1a1a] border border-slate-200 dark:border-[#2a2a2a] relative overflow-hidden shadow-xl dark:shadow-2xl transition-colors duration-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 divide-y md:divide-y-0 md:divide-x divide-slate-200 dark:divide-[#2a2a2a]">
            <div className="pt-3 md:pt-0 md:px-4 text-center md:text-left space-y-1">
              <div className="text-3xl md:text-5xl font-extrabold text-sky-500 dark:text-[#38bdf8] font-mono tracking-tight flex items-baseline justify-center md:justify-start gap-1">
                <span>6</span>
                <span className="text-xl text-sky-500 dark:text-[#38bdf8]">+</span>
              </div>
              <div className="text-xs text-slate-500 dark:text-[#888888] font-medium uppercase tracking-wider">
                Years Experience
              </div>
            </div>

            <div className="pt-3 md:pt-0 md:px-6 text-center md:text-left space-y-1">
              <div className="text-3xl md:text-5xl font-extrabold text-sky-500 dark:text-[#38bdf8] font-mono tracking-tight flex items-baseline justify-center md:justify-start gap-1">
                <span>120</span>
                <span className="text-xl text-sky-500 dark:text-[#38bdf8]">+</span>
              </div>
            ...
            <div className="pt-3 md:pt-0 md:px-6 text-center md:text-left space-y-1">
              <div className="text-3xl md:text-5xl font-extrabold text-slate-900 dark:text-white font-mono tracking-tight flex items-baseline justify-center md:justify-start gap-1">
                <span>99.9</span>
                <span className="text-xl text-sky-500 dark:text-[#38bdf8]">%</span>
              </div>
              <div className="text-xs text-slate-500 dark:text-[#888888] font-medium uppercase tracking-wider">
